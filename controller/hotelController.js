...
async function getMax(req, res) {
    try {
        const minRooms = parseInt(req.query.minRooms) || 10; // Default to 10 if not provided
        const maxRooms = parseInt(req.query.maxRooms) || 100; // Default to 100 if not provided
